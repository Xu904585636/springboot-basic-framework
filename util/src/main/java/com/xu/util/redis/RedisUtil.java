...
public class RedisUtil {
    ...
    public void lock(String key, String value, Integer timeout) {
        Assert.isTrue(!StringUtil.isNullOrEmpty(key), "redis locks are identified as null.");
        Assert.isTrue(!StringUtil.isNullOrEmpty(value), "the redis release lock is identified as null.");
        int cycles = CYCLES;
    ...
    public void unLock(String key, String value) {
        Assert.isTrue(!StringUtil.isNullOrEmpty(key), "redis locks are identified as null.");
        Assert.isTrue(!StringUtil.isNullOrEmpty(key), "the redis release lock is identified as null.");
        key = REDIS_LOCK + key;
